            ...
            for messaging_event in entry["messaging"]:
                ...
                if messaging_event.get("postback"):
                    ...
                    if payload == "BRAND_APPLE":
                        ...
                        bot.send_image_url(
                            sender_id, "https://example.com/images/apple_iphone.jpg"
                        )
                        bot.send_text_message(sender_id, "- iPhone 14")
                        bot.send_image_url(
                            sender_id, "https://example.com/images/apple_macbook.jpg"
                        )
                        bot.send_text_message(sender_id, "- MacBook Air")
                        bot.send_image_url(
                            sender_id, "https://example.com/images/apple_watch.jpg"
                        )
                        bot.send_text_message(sender_id, "- Apple Watch")

                    if payload == "BRAND_SAMSUNG":
                        bot.send_text_message(
                            sender_id, "Here are products for Samsung:"
                        )
                        bot.send_image_url(
                            sender_id, "https://example.com/images/samsung_galaxy.jpg"
                        )
                        bot.send_text_message(sender_id, "- Galaxy S23")
                        bot.send_image_url(
                            sender_id, "https://example.com/images/samsung_tab.jpg"
                        )
                        bot.send_text_message(sender_id, "- Galaxy Tab S8")
                        bot.send_image_url(
                            sender_id, "https://example.com/images/samsung_watch.jpg"
                        )
                    ...
                    if payload == "BRAND_SONY":
                        ...
                        bot.send_image_url(
                            sender_id, "https://example.com/images/sony_bravia.jpg"
                        )
                        bot.send_text_message(sender_id, "- Sony Bravia TV")
                        bot.send_image_url(
                            sender_id, "https://example.com/images/sony_headphones.jpg"
                        )
                    ...
                    if messaging_event["message"].get("text"):
                        ...
                        if query == "show brands":
                            ...
                            bot.send_button_message(
                                sender_id, "Select a brand to see products:", buttons
                            )
                        else:
                            bot.send_text_message(
                                sender_id, "Send 'Show Brands' to see available brands."
                            )
